...
export default function ResultBanner({
  ...
  return (
    <>
      {result === "win" && (
        <div className="absolute left-3 right-3 bottom-0 h-1/5 flex items-center justify-center text-center py-2 px-4 rounded-md bg-[#6b798f] shadow-2xl border-black border-2">
      ...
      {result !== "win" && (
        <>
          ...
          <div className="z-50 absolute left-4 right-4 bottom-5 h-1/2 flex items-center justify-center text-center py-2 px-4 rounded-md bg-[#6b798f] shadow-2xl border-black border-2">
